...
import { Thermometer, ArrowDown, Info } from "lucide-react";
            ...
            <div className="container mx-auto px-4">
                ...
                <div className="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <h2 className="text-3xl md:text-5xl font-bold font-robotoslab text-primary mb-6">
                        Win de strijd tegen de hitte.
                    </h2>
                    <p className="text-secondary opacity-70 text-lg leading-relaxed">
                        Gordijnen aan de binnenkant houden het licht wel tegen, maar de warmte zit dan al binnen (het 'broeikas-effect').
                        Screens blokkeren de zon <span className="font-bold text-primary">voordat</span> deze het glas raakt.
                    </p>

                    <div className="mt-8 inline-flex items-center gap-2 bg-white px-6 py-3 rounded-full shadow-sm border border-blue-100 text-blue-800 font-bold">
                        <Thermometer className="w-5 h-5" />
                        Weert tot 92% zonnewarmte
                    </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                    ...
                    <div className="bg-white p-8 rounded-3xl shadow-sm border border-red-100 flex flex-col items-center relative overflow-hidden group">
                        ...
                        <h3 className="text-xl font-bold text-red-900 mb-2">Binnenzonwering</h3>
                        <p className="text-sm text-red-400 mb-8 font-medium">Warmte zit gevangen</p>
                        ...
                        <div className="mt-8 flex items-center gap-4">
                            <div className="w-16 h-16 rounded-full bg-red-50 flex items-center justify-center border-4 border-red-100">
                                <Thermometer className={`w-8 h-8 transition-colors duration-1000 ${isPlaying ? "text-red-600" : "text-gray-400"}`} />
                            </div>
                            <div>
                                <p className="text-sm font-bold text-gray-400 uppercase">Temperatuur</p>
                                <p className={`text-4xl font-bold font-mono transition-colors duration-1000 ${isPlaying ? "text-red-500" : "text-primary"}`}>
                                    <Counter value={isPlaying ? 28 : 21} />°C
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white p-8 rounded-3xl shadow-lg border border-blue-200 flex flex-col items-center relative overflow-hidden ring-4 ring-blue-50/50">
                        ...
                        <h3 className="text-xl font-bold text-blue-900 mb-2">Solar Screen (Buiten)</h3>
                        <p className="text-sm text-blue-500 mb-8 font-medium">Warmte wordt weerkaatst</p>
                        ...
                        <div className="relative w-64 h-64 bg-blue-50/30 rounded-xl border-2 border-blue-100 flex items-center justify-center p-4 shadow-inner">
                            ...
                            {/* The Screen (Outside/Left) */}
                            <div className="absolute top-4 bottom-4 left-24 w-1 bg-gray-800 z-30 shadow-sm border-r border-gray-600"></div>
